...
val gh = GitHubSettings(org = "yosifovemil", proj = "scala-cats-sandbox", publishOrg = "yosifovemil", license = apache2)

val mainDev =
  Developer("Emil Yosifov", "@yosifovemil", "yosifovemil@gmail.com", new java.net.URL("http://github.com/yosifovemil"))
...
lazy val Scalacatssandbox = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "scala-cats-sandbox"),
    micrositeDocumentationUrl := "/scala-cats-sandbox/api/yosifovemil/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "yosifovemil"
  )
